function [B rcondu p q norG norH] = clsolvenorm(G,H,t,s,B,piv)
%CLSOLVENORM Solution of a Cauchy-like linear system.
% ***** THIS VERSION STORES THE NORMS OF THE GENERATORS *****
...
switch piv
    ...
    case 0	% no pivoting
	    ...
	    %
            ...
            %
	    norG(k+1) = norm( reshape(G(k+1:n,:),(n-k)*dr,1), inf);
	    norH(k+1) = norm( reshape(H(:,k+1:n),(n-k)*dr,1), inf);
        end
